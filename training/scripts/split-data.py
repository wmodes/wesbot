...
def split_jsonl(input_filename, test_percentage):
    ...
    print(f"Training data ({100-test_percentage}%) saved to {training_filepath}.")
    print(f"Test data ({test_percentage}%) saved to {test_filepath}")
    print(f"Compiled data (100%) in {input_filename}")
